...
public class ExtendedRichTextBox : RichTextBox
{
    ...
    public CharStyle SelectionCharStyle
    {
        get
        {
            ...
            if (param.crBackColor > 0 && param.crTextColor > 0) { } else if (param.crBackColor > 0) {
            ...
            else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC || param.dwEffects == CFE_BOLD + CFE_ITALIC) { cs.Bold = true; cs.Italic = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_UNDERLINE || param.dwEffects == CFE_BOLD + CFE_UNDERLINE) { cs.Bold = true; cs.Underline = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_STRIKEOUT || param.dwEffects == CFE_BOLD + CFE_STRIKEOUT) { cs.Bold = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_LINK) { cs.Bold = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_UNDERLINE || param.dwEffects == CFE_ITALIC + CFE_UNDERLINE) { cs.Italic = true; cs.Underline = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_STRIKEOUT || param.dwEffects == CFE_ITALIC + CFE_STRIKEOUT) { cs.Italic = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_LINK || param.dwEffects == CFE_ITALIC + CFE_LINK) { cs.Italic = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_UNDERLINE + CFE_STRIKEOUT || param.dwEffects == CFE_UNDERLINE + CFE_STRIKEOUT) { cs.Underline = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_STRIKEOUT + CFE_LINK) { cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE) { cs.Bold = true; cs.Italic = true; cs.Underline = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_STRIKEOUT || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_STRIKEOUT) { cs.Bold = true; cs.Italic = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_LINK) { cs.Bold = true; cs.Italic = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT || param.dwEffects == CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT) { cs.Bold = true; cs.Underline = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_UNDERLINE + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_UNDERLINE + CFE_LINK) { cs.Bold = true; cs.Underline = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT || param.dwEffects == CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT) { cs.Italic = true; cs.Underline = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_UNDERLINE + CFE_LINK || param.dwEffects == CFE_ITALIC + CFE_UNDERLINE + CFE_LINK) { cs.Italic = true; cs.Underline = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_ITALIC + CFE_STRIKEOUT + CFE_LINK) { cs.Italic = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK) { cs.Underline = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT) { cs.Bold = true; cs.Italic = true; cs.Underline = true; cs.Strikeout = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_LINK) { cs.Bold = true; cs.Italic = true; cs.Underline = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_STRIKEOUT + CFE_LINK) { cs.Bold = true; cs.Italic = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK) { cs.Bold = true; cs.Underline = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK) { cs.Bold = true; cs.Underline = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK) { cs.Italic = true; cs.Underline = true; cs.Strikeout = true; cs.Link = true; } else if (param.dwEffects == DEFAULT_EFFECTS + CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK || param.dwEffects == CFE_BOLD + CFE_ITALIC + CFE_UNDERLINE + CFE_STRIKEOUT + CFE_LINK) { cs.Bold = true; cs.Italic = true; cs.Underline = true; cs.Strikeout = true; cs.Link = true; } else cs = new CharStyle(); //style was not recognized...            
            return cs;
        }
        set
        {
